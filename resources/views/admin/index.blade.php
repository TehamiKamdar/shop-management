                                ...
                                ">Approved</span>
                                        <span class="action-icons active">
                                            ...
                                            <a href="javascript:void(0)" class="ps-3"><i
                                                    class="ti ti-arrow-badge-right-x fs-5"></i></a>
                                            <a href="javascript:void(0)" class="ps-3"><i
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="card-title mb-0" id="date-time">Today</h4>
                        </div>
                        <div class="d-flex align-items-center flex-row mt-4">
                            <div class="p-2 display-5 text-primary">
                                <span id="weather-icon"></span>
                                <span id="temperature">--<sup>°</sup></span>
                            </div>
                            <div class="p-2">
                                <h3 class="mb-0" id="day">--</h3>
                        ...
                        <table class="table table-borderless">
                            <tbody>
                                <tr>
                                    <td>Wind</td>
                                    <td class="fw-medium" id="wind">--</td>
                                </tr>
                                <tr>
                                    <td>Humidity</td>
                                    <td class="fw-medium" id="humidity">--</td>
                                </tr>
                                <tr>
                                    <td>Pressure</td>
                                    <td class="fw-medium" id="pressure">--</td>
                                </tr>
                                <tr>
                                    <td>Cloud Cover</td>
                                    <td class="fw-medium" id="cloud">--</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
